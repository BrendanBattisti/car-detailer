      ...
      {isRv ? (
        <div>
          ...
          <div className="max-w-xl mx-auto">
            <div className="service-card bg-background-200 rounded-lg overflow-hidden shadow-lg">
              <div className="animate-in p-6">
                <p className="text-subtext text-sm mt-2 text-center">
                  Professional RV cleaning priced by size for simple, transparent
                  estimates.
                </p>
                <p className="text-primary text-2xl font-bold mt-4 text-center">
                  ${RV_SQFT_RATE}/sq ft
                </p>
              </div>
            </div>
